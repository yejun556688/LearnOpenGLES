...
- (void)viewDidLoad {
    ...
    if (true) {
        ...
        GLKMatrix4 projectionMatrix = GLKMatrix4MakePerspective(30, 3.0 / 4.0, 1.0, 10.0);
        
        modelViewMatrix = GLKMatrix4Translate(
                                              modelViewMatrix,
                                              0.0f, 0.0f, -2.0f);
        modelViewMatrix = GLKMatrix4RotateZ(modelViewMatrix, 0.5);
        modelViewMatrix = GLKMatrix4RotateX(modelViewMatrix, 0.5);
        modelViewMatrix = GLKMatrix4RotateY(modelViewMatrix, 0.5);

        self.baseEffect.transform.modelviewMatrix = modelViewMatrix;
        self.extraEffect.transform.modelviewMatrix = modelViewMatrix;
        
        self.baseEffect.transform.projectionMatrix = projectionMatrix;
        self.extraEffect.transform.projectionMatrix = projectionMatrix;
    }
