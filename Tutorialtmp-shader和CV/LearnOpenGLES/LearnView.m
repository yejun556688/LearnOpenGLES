...
- (void)render {
    ...
    GLuint map = glGetUniformLocation(self.myProgram, "colorMap");
    glUniform1i(map, 1);
...
- (GLuint)setupTexture {
    ...
    CVOpenGLESTextureCacheCreate(kCFAllocatorDefault, NULL, self.myContext, NULL, &coreVideoTextureCache);
    ...
    NSLog(@"CVOpenGLESTextureGetName(renderTexture) %d", CVOpenGLESTextureGetName(renderTexture));
